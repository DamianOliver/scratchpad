...
def game_over():
    ...
    quinstructions = font_instructions.render("Press q to Quit", True, (255,255,255))
    quinstructions_rect = quinstructions.get_rect(center = (int(display_width/2), int(display_height/1.5)))
    display.blit(quinstructions, quinstructions_rect)
...
welcome = welcome_screen.render("Lets's Play Pong!", True, (255,255,255))
welcome_rect = welcome.get_rect(center = (int(display_width/2), int(display_height/3)))
startmsg = welcome_screen.render("Press 'y' to start, or autostart in 10 seconds", True, (255,255,255))
