...
def print_students(student_list):
    for i in range(len(student_list)):
        ...
        # print_list.append([student_list[i].name, student_list[i].ethnicity, student_list[i].english_skill, student_list[i].academic_skill, student_list[i].age])
                                    ...
                                    if second_student.ethnicity not in not_allowed_list:
                                        if second_student.academic_skill == student.academic_skill:
                                            ...
                                            if first_english == second_english:
                                                    print("swapped {}: {} and {}: {}".format(student.name, student.ethnicity, second_student.name, second_student.ethnicity))
                                                    student_list[a][i] = second_student
                                                    student_list[x + 1 + a][y] = student
                                ...
                                if first_english == second_english:
                                    ...
                                    if num_white_2 >= 8:
                                        ...
                                        if student.ethnicity not in not_allowed_list or not_allowed_list_2:
                                            print("swapped {} and {}. Median of {}".format(student.english_skill, second_student.english_skill, class_median))
                                            student_list[a][i] = second_student
                                            student_list[x + 1 + a][y] = student
                                            should_break = True
                                            break
...
print("How many students would you like to generate?")
...
# GOALS FOR EACH CLASS (IN ORDER OF PRIORITY)

# Classes must be 28-32 students in size with the exception being when there aren't enough students for another full class (I may just make this 30 students for simplicity)
# All students are to be the same academic skill level
# Students with english levels of 3 or 4 are not to be mixed with students with english levels of 1 or 2 or vise versa
# No ethnicity present should be represented with less than 4 students and with more than 8
# No age present should be represented by less than 4 students

# all rules only apply when possible, and when they do not conflict with another rule of higher priority